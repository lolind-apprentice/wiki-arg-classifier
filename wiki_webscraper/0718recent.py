...
while current_date <= end_date:
    ...
    if page.exists():
        ...
        for template in templates:
            ...
            if template_name.lower().startswith("wikipedia:articles for deletion/"):
                ...
                discussion_title = template_name[len("Wikipedia:Articles for deletion/"):].strip()
...
# write to CSV
with open("yearly_afd_comments_2023_2024.csv", "w", newline="", encoding="utf-8") as f:
    writer = csv.writer(f)
    writer.writerow(["article", "user", "date", "timestamp", "comment"])
    writer.writerows(all_rows)

print("✅ CSV file 'afd_comments_2022_.csv' written successfully.")
